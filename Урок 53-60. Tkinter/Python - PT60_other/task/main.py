...
# ДОПОЛНИТЕ КОД ИСПОЛЬЗОВАНИЕМ РАДИОКНОПКИ И ОБНОВЛЕНИЕМ КОМБОБОКСА
def fs_add_student():
...
# ДОПОЛНИТЕ КОД ОБНОВЛЕНИЕМ КОМБОБОКСА
...
# ДОПОЛНИТЕ КОД ИСПОЛЬЗОВАНИЕМ КОМБОБОКСА ГРУППЫ
def fgd_select_group():
    global selected_group
    group_index = 0  # ЗАГЛУШКА
...
# ДОПОЛНИТЕ КОД ИСПОЛЬЗОВАНИЕМ КОМБОБОКСА СТУДЕНТА
def fgd_add_student_to_group():
    student_index = 0  # ЗАГУЛШКА
