...
# ====================================================================================================
# Задание 18 - пользователь вводит строку из чисел через пробел. Требуется сформировать из чисел список,
#              найти сумму и произведение всех чисел в списке.

# Задание 19 - пользователь вводит строку из чисел через пробел. Требуется проверить, есть ли в списке
#              чётные числа.

# Задание 20 - пользователь вводит строку из чисел через пробел. Требуется посчитать, сколько раз
#              встречаются чётные и нечётные числа.

# Задание 21 - пользователь вводит строку из чисел через пробел и на следующей строке число. Требуется
#              сформировать список и посчитать, сколько раз встречается данное число в списке.
...
# my_list = ["Bob", "Jim", "Tom", "Kid", "Arthur", "Kate", "Lisa", "Tom"]
# my_list[1] = 47
# print(my_list)
...
# ====================================================================================================
# Задание 22 - пользователь построчно вводит числа. Программа добавляет введённые числа в список.
#              Если пользователь ввёл число 0, то программа выводит список введённых чисел и завершается.

# Задание 23 - пользователь вводит число n (n>=1), затем n раз вводит число на каждой строке.
#              Требуется вывести максимальный элемент. Гарантируется, что пользователь введёт
#              как минимум одно число после ввода числа
#
...
# Задание 24 - пользователь вводит в первой строке элементы через пробел. На второй строке пользователь
#              вписывает элемент, который хочет найти. Если такой элемент есть в списке, вывести индекс
#              этого элемента. (Не использовать .index())

# Задание 25 - пользователь вводит в первой строке элементы через пробел. Далее на второй строке
#              он также вводит элементы через пробел. Требуется сформировать из двух списков один список
#              и вывести его.

# Задание 26 - пользователь вводит в первой строке элементы через пробел. На второй строке пользователь
#              вводит позицию элемента (не индекс). Программа должна удалить элемент по заданной позиции.

# Задание 27 - пользователь вводит в первой строке элементы через пробел. На второй строке пользователь
#              вводит элемент. Программа должна найти этот элемент в списке и удалить его.
#              (Не использовать .remove()). Написать 2 варианта - программа удаляет первое вхождение
#              и программа удаляет каждое вхождение.

# Задание 28 - пользователь вводит в первой строке числа через пробел. Нужно составить списки по
#              следующим требованиям:
#              1. Список, который содержит только чётные числа из первого списка
#              2. Список, который содержит только отрицательные числа
#              3. Список, который содержит только те числа, что больше 100 и делятся на 5

# Задание 29 - пользователь вводит число n. Далее n раз он вводит строку чисел через пробел. Требуется
#              сначала сформировать список из введённой строки, а затем объединить в один большой список.
# ====================================================================================================
